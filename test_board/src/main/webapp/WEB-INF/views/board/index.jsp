...
<html>
   ...
   <body>
                        ...
                        <c:when test="${!empty boardList}">
                           <c:forEach var="list" items="${boardList}">
                              <tr>
                                 ...
                                 <td>
                                 	<a href="#" onClick="getContent(<c:out value="${list.bid}"/>)">
    ...
    <script>
		var btnWriteForm = document.querySelector("#btnWriteForm");
		
		btnWriteForm.addEventListener("click", function(evt){
			evt.preventDefault();
